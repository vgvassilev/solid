...
Scan is only performed once and the location is cached. If the lib location is
changed, visit the module setting page at admin/settings/syntaxhighlighter
to force a re-scan
