...
namespace SolidIDE
{
	public partial class LoadedPlugins
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget SolidIDE.LoadedPlugins
			this.Name = "SolidIDE.LoadedPlugins";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child SolidIDE.LoadedPlugins.VBox
			...
			w3.Position = 0;
			// Internal child SolidIDE.LoadedPlugins.ActionArea
