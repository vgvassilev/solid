...
namespace SolidReflector
{
	public partial class LoadedPlugins
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget SolidReflector.LoadedPlugins
			this.Name = "SolidReflector.LoadedPlugins";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child SolidReflector.LoadedPlugins.VBox
			...
			w3.Position = 0;
			// Internal child SolidReflector.LoadedPlugins.ActionArea
