...
namespace SolidV.Gtk.InspectorGrid
{
  ...
  public class InspectorEditorCell
  {
    Pango.Layout layout;
  ...
  class DefaultInspectorEditor: Gtk.Entry, IInspectorEditor
  {
    PropertyDescriptor property;
    
    public void Initialize(EditSession session)
    {
      this.property = session.Inspector;
    }
  ...
  public class EditSession : ITypeDescriptorContext
  {
    ...
    object obj;
    Gtk.Widget container;
    IInspectorEditor currentEditor;
    bool syncing;
    ...
    public IInspectorEditor Editor {
...
*/    
  ...
  class InspectorDialogueEditor: HBox, IInspectorEditor
  {
    InspectorEditorCell cell;
  ...
  public interface IInspectorEditor: IDisposable
  {
