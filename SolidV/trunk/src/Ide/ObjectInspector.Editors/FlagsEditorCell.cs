...
namespace SolidV.Gtk.InspectorGrid.InspectorEditors {
  using Gtk = global::Gtk;
	public class FlagsEditorCell: InspectorEditorCell
	{
		protected override string GetValueText()
		{
			...
			Array values = System.Enum.GetValues(base.Inspector.PropertyType);
			string txt = "";
	...
	public class FlagsEditor : Gtk.HBox, IInspectorEditor
	{
		Hashtable flags;
